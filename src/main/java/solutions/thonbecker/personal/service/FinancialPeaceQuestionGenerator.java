...
public class FinancialPeaceQuestionGenerator {
    ...
    private List<Question> generateFallbackQuestions(int count) {
        ...
        String[][] options = {
                ...
                {"Pay off debts largest to smallest", "Pay off debts smallest to largest", "Pay minimum on all debts", "Pay highest interest first"},
                {"5%", "10%", "15%", "20%"},
                ...
                {"A fund for emergencies", "A fund for specific future expenses", "A retirement account", "A debt payment plan"},
                ...
                {"The four Baby Steps", "Four types of insurance", "Four essential budget categories", "Four investment types"},
                ...
                {"Using cash for all purchases", "Using cash in envelopes for budget categories", "Hiding money in envelopes", "Mailing bills in envelopes"}
        };
