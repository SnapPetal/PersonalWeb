...
public enum SupportedTrick {
    ...
    HALFCAB(
            "Half Cab",
            "Fakie backside 180 where the rider approaches backward and rotates 180 degrees into regular stance"),
    ...
    CROOKED_GRIND(
            "Crooked Grind",
            "Front truck locks onto the obstacle at an angled pinched position while the back truck stays off"),
