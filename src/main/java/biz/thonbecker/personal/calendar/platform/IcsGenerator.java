...
/**
 * Generates iCalendar (.ics) content for CalDAV events with deterministic UIDs.
 */
@Service
@Slf4j
class IcsGenerator {
    ...
    /**
     * Generates an iCalendar (.ics) file content with a deterministic UID for CalDAV.
     *
     * @param event The booking created event
     * @param organizerEmail Email address of the organizer
     * @param uid Deterministic UID for the calendar event
